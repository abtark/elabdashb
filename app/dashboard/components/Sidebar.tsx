...
export default function Sidebar({ menuItems, activeApp, setActiveApp, onLogout }: SidebarProps) {
  return (
    <div className="w-24 flex flex-col items-center py-6 gap-6 border-r border-white/20 dark:border-white/10 bg-white/10 dark:bg-white/5 shrink-0 z-20 backdrop-blur-md">
      ...
      <div className="mt-auto mb-2">
         <button 
           onClick={onLogout}
           className="p-3 block rounded-2xl hover:bg-red-500/10 text-red-500 transition-colors opacity-60 hover:opacity-100"
         >
            <LogOut size={26} />
         </button>
      </div>
